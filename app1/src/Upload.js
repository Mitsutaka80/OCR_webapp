...
class Upload extends Component {
    ...
    await fetch(
        'https://atcl1ihzbi.execute-api.eu-west-2.amazonaws.com/Production',
        {
        method: "POST",
        harders: {
    ...
    const response = await fetch(
        'https://atcl1ihzbi.execute-api.eu-west-2.amazonaws.com/Production/ocr',
        {
        method: "POST",
        harders: {
            Accept : "application/json",
    ...
    // className="col-6 offest-3"
    // It always have 12 so 3 on the right, 3 on the left and 6 on midle 
    render(){
                ...
                <div className="col-6 offset-3">
                    <Form onSubmit={this.handleSubmit} >
                        ...
                        <div className="top-element-formatting">
                            {" "}
                            <span className="second-word-formatting"> Click submit when you finsh </span>
                        </div>
